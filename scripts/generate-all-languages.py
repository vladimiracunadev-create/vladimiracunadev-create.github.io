...
def get_content(lang):
 ...
 "Problem Driven Systems Lab — Laboratorio de sistemas distribuido con 12 casos reales Docker-first para diagnosticar y resolver problemas críticos de rendimiento, observabilidad, resiliencia y arquitectura",                "Gabysql — ️ GabySQL · Base de datos embebida en Rust, multiplataforma, archivo único .db, WAL, API HTTP/JSON y admin web liviano. Diseñada para entornos embebidos y edge",],
            "projects_ats": [
 ...
 ("Problem Driven Systems Lab — Laboratorio de sistemas distribuido con 12 casos reales Docker-first para diagnosticar y resolver problemas críticos de rendimiento, observabilidad, resiliencia y arquitectura:", "problem"),                ("Gabysql — ️ GabySQL · Base de datos embebida en Rust, multiplataforma, archivo único .db, WAL, API HTTP/JSON y admin web liviano. Diseñada para entornos embebidos y edge:", "gabysql"),
],
            "training": [
            ...
            "skills_labels": ["<b>Backend:</b>", "<b>Frontend:</b>", "<b>Datos:</b>", "<b>DevOps/Cloud:</b>", "<b>Calidad/Seguridad:</b>", "<b>Observabilidad:</b>", "<b>IA/Agentes:</b>", "<b>Tooling propio (open source):</b>"],
            "degrees": [
 ...
 ("Problem Driven Systems Lab — Laboratorio de sistemas distribuido con 12 casos reales Docker-first para diagnosticar y resolver problemas críticos de rendimiento, observabilidad, resiliencia y arquitectura:", "problem"),                ("Gabysql — ️ GabySQL · Base de datos embebida en Rust, multiplataforma, archivo único .db, WAL, API HTTP/JSON y admin web liviano. Diseñada para entornos embebidos y edge:", "gabysql"),
            ...
            "skills_labels": ["<b>Backend:</b>", "<b>Frontend:</b>", "<b>Data:</b>", "<b>DevOps/Cloud:</b>", "<b>Quality/Security:</b>", "<b>Observability:</b>", "<b>AI/Agents:</b>", "<b>Own tooling (open source):</b>"],
            "degrees": [
 ...
 ("Problem Driven Systems Lab — Laboratorio de sistemas distribuido con 12 casos reales Docker-first para diagnosticar y resolver problemas críticos de rendimiento, observabilidad, resiliencia y arquitectura:", "problem"),                ("Gabysql — ️ GabySQL · Base de datos embebida en Rust, multiplataforma, archivo único .db, WAL, API HTTP/JSON y admin web liviano. Diseñada para entornos embebidos y edge:", "gabysql"),],
            ...
            "skills_labels": ["<b>Backend:</b>", "<b>Frontend:</b>", "<b>Dados:</b>", "<b>DevOps/Cloud:</b>", "<b>Qualidade/Seguran\u00e7a:</b>", "<b>Observabilidade:</b>", "<b>IA/Agentes:</b>", "<b>Tooling pr\u00f3prio (open source):</b>"],
            "degrees": [
 ...
 ("Problem Driven Systems Lab — Laboratorio de sistemas distribuido con 12 casos reales Docker-first para diagnosticar y resolver problemas críticos de rendimiento, observabilidad, resiliencia y arquitectura:", "problem"),                ("Gabysql — ️ GabySQL · Base de datos embebida en Rust, multiplataforma, archivo único .db, WAL, API HTTP/JSON y admin web liviano. Diseñada para entornos embebidos y edge:", "gabysql"),
            ...
            "skills_labels": ["<b>Backend:</b>", "<b>Frontend:</b>", "<b>Dati:</b>", "<b>DevOps/Cloud:</b>", "<b>Qualit\u00e0/Sicurezza:</b>", "<b>Osservabilit\u00e0:</b>", "<b>IA/Agenti:</b>", "<b>Tooling proprio (open source):</b>"],
            "degrees": [
 ...
 ("Problem Driven Systems Lab — Laboratorio de sistemas distribuido con 12 casos reales Docker-first para diagnosticar y resolver problemas críticos de rendimiento, observabilidad, resiliencia y arquitectura:", "problem"),                "Gabysql — ️ GabySQL · Base de datos embebida en Rust, multiplataforma, archivo único .db, WAL, API HTTP/JSON y admin web liviano. Diseñada para entornos embebidos y edge",],
            ...
            "projects_rec": [
                ...
                "Unikernel Labs \u2014 Control Center Windows (WSL2 + Node.js + WinForms)",
                "ChofyAI Studio \u2014 lanceur IA locale macOS (Tauri + Rust + React)",                ("Gabysql — ️ GabySQL · Base de datos embebida en Rust, multiplataforma, archivo único .db, WAL, API HTTP/JSON y admin web liviano. Diseñada para entornos embebidos y edge :", "gabysql"),
],
            "projects_ats": [
            ...
            "skills_labels": ["<b>Backend :</b>", "<b>Frontend :</b>", "<b>Donn\u00e9es :</b>", "<b>DevOps/Cloud :</b>", "<b>Qualit\u00e9/S\u00e9curit\u00e9 :</b>", "<b>Observabilit\u00e9 :</b>", "<b>IA/Agents :</b>", "<b>Outils maison (open source) :</b>"],
            "degrees": [
 ...
 ("Problem Driven Systems Lab — Laboratorio de sistemas distribuido con 12 casos reales Docker-first para diagnosticar y resolver problemas críticos de rendimiento, observabilidad, resiliencia y arquitectura ：", "problem"),                "Gabysql — ️ GabySQL · Base de datos embebida en Rust, multiplataforma, archivo único .db, WAL, API HTTP/JSON y admin web liviano. Diseñada para entornos embebidos y edge",],
            ...
            "projects_rec": [
                ...
                "ChofyAI Studio \u2014 macOS\u672c\u5730AI\u542f\u52a8\u5668 (Tauri + Rust + React)",                ("Gabysql — ️ GabySQL · Base de datos embebida en Rust, multiplataforma, archivo único .db, WAL, API HTTP/JSON y admin web liviano. Diseñada para entornos embebidos y edge：", "gabysql"),
],
            "projects_ats": [
            ...
            "skills_labels": ["<b>\u540e\u7aef\uff1a</b>", "<b>\u524d\u7aef\uff1a</b>", "<b>\u6570\u636e\uff1a</b>", "<b>DevOps/\u4e91\uff1a</b>", "<b>\u8d28\u91cf/\u5b89\u5168\uff1a</b>", "<b>\u53ef\u89c2\u6d4b\u6027\uff1a</b>", "<b>AI/\u4ee3\u7406\uff1a</b>", "<b>\u81ea\u7814\u5de5\u5177\uff08\u5f00\u6e90\uff09\uff1a</b>"],
            "degrees": [
...
SKILLS_VALUES = [
    ...
    "Claude Skills Toolkit (Python, security-audit 12 capas, yaml-control, md-lint-fix, docker-cleanup), GabySQL (Rust, DB embebida WAL, HTTP/JSON), Python Data Science Program (197 clases ML/DL/MLOps, Flask + Windows + Android)",
]
...
def make_sidebar(lang):
    ...
    return dict(
        ...
        h_skills=T["h_skills"],
        skills=[f"{T['skills_labels'][i]} {SKILLS_VALUES[i]}" for i in range(8)],
...
def make_ats(lang):
    ...
    return dict(
        ...
        h_skills=T["h_skills"],
        skills=[(T["skills_labels"][i], SKILLS_VALUES[i]) for i in range(8)],
