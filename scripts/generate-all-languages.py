...
def get_content(lang):
 ...
 "Problem Driven Systems Lab — 12 desafíos × 5 stacks = 60 casos operativos Docker-first para diagnosticar y resolver problemas críticos de rendimiento, observabilidad, resiliencia y arquitectura",
                ...
                "Modern Gamedev Program — El programa de desarrollo de videojuegos más completo en español — 45 clases listas de ~292 (18 partes), de fundamentos a nivel profesional. Matemáticas, C#/C++/GDScript, patrones y ECS; de un sprite a un plataformas 2D completo con Godot 4. Motores Godot · Unity · Unreal. ️",
                "Modern Cybersecurity Program — ️ El programa de ciberseguridad más completo en español — 340 clases, 19 partes, de fundamentos a nivel experto. Laboratorios Docker, retos CTF, autoevaluaciones, guías PDF/PPTX y mapeo a 7 certificaciones (Security+, PenTest+, CySA+, OSCP, CISSP, BTL1, SANS) con 86–92% de cobertura",
                "Machine Operator Program — ️ Base documental del Programa de Operación y Simulación de Máquinas — mandos, instrumentos, historia, reglamentos y diseño de simulación de motos, autos, buses, grúas, buques, aeronaves y naves espaciales, con foco educativo y de seguridad",
 ...
 ("Problem Driven Systems Lab — 12 desafíos × 5 stacks = 60 casos operativos Docker-first para diagnosticar y resolver problemas críticos de rendimiento, observabilidad, resiliencia y arquitectura:", "problem"),
                ...
                ("Rootcause Mobile Inspector — RootCause Mobile — sensor forense de diagnóstico para Android e iOS (Flutter). Toda distorsión anómala de recursos (memoria, almacenamiento, batería, superficie de permisos) puede ser el primer indicio de una amenaza: la detecta con motor de reglas local y deja evidencia exportable. APK firmado en Releases. Telemetría: cero:", "rootcause"),
                ("Modern Gamedev Program — El programa de desarrollo de videojuegos más completo en español — 45 clases listas de ~292 (18 partes), de fundamentos a nivel profesional. Matemáticas, C#/C++/GDScript, patrones y ECS; de un sprite a un plataformas 2D completo con Godot 4. Motores Godot · Unity · Unreal. ️:", "modern"),
                ("Machine Operator Program — ️ Base documental del Programa de Operación y Simulación de Máquinas — mandos, instrumentos, historia, reglamentos y diseño de simulación de motos, autos, buses, grúas, buques, aeronaves y naves espaciales, con foco educativo y de seguridad:", "machine"),
 ...
 ("Problem Driven Systems Lab — 12 desafíos × 5 stacks = 60 casos operativos Docker-first para diagnosticar y resolver problemas críticos de rendimiento, observabilidad, resiliencia y arquitectura:", "problem"),
            ...
            "projects_ats": [
                ...
                ("RootCause · Windows Inspector v0.11.0 — Diagnóstico forense Windows 10/11 en Rust: ETW + WPR, 5 ediciones (Setup.exe, Portable .zip, CLI rootcause.exe, PowerShell .psm1, VS Code .vsix):", "rootcause"),
                            ("RootCause · Windows Inspector v0.11.0 — Diagnóstico forense Windows 10/11 en Rust: ETW + WPR, 5 ediciones (Setup.exe, Portable .zip, CLI rootcause.exe, PowerShell .psm1, VS Code .vsix):", "rootcause"),
                ("Modern Cybersecurity Program — ️ El programa de ciberseguridad más completo en español — 340 clases, 19 partes, de fundamentos a nivel experto. Laboratorios Docker, retos CTF, autoevaluaciones, guías PDF/PPTX y mapeo a 7 certificaciones (Security+, PenTest+, CySA+, OSCP, CISSP, BTL1, SANS) con 86–92% de cobertura:", "modern"),
],
            "training": [
