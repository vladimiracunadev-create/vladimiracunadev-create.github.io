...
PROJECTS_URLS = {
    ...
    "codex": "https://github.com/vladimiracunadev-create/codex-skills-toolkit",
    "rootcause_qr": "https://github.com/vladimiracunadev-create/rootcause-qr-inspector",
    "chilean": "https://github.com/vladimiracunadev-create/chilean-school-learning-path",
    "architecture": "https://github.com/vladimiracunadev-create/architecture-built-environment-learning-program",
    "pdf": "https://github.com/vladimiracunadev-create/pdf-reader-windows-android",
    "universal_payments": "https://github.com/vladimiracunadev-create/universal-payments-engineering-lab",
    "psychometrics": "https://github.com/vladimiracunadev-create/psychometrics-and-assessment-program",
    "rootcause_server": "https://github.com/vladimiracunadev-create/rootcause-server",
    "aws": "https://github.com/vladimiracunadev-create/aws-desktop-studio",
    "rootcause_blockchain": "https://github.com/vladimiracunadev-create/rootcause-blockchain-security",
    "rootcause_bitcoin": "https://github.com/vladimiracunadev-create/rootcause-bitcoin-defense",
    "decentraland": "https://github.com/vladimiracunadev-create/decentraland-social-arcade",
    "commerce": "https://github.com/vladimiracunadev-create/commerce-operating-system",
    "panuelo": "https://github.com/vladimiracunadev-create/panuelo-al-viento-cueca-app",
    "qemu": "https://github.com/vladimiracunadev-create/qemu-kvm-labs",
    ...
    T = {
        "es": {
            ...
            "projects_rec": [
                ...
                "Codex Skills Toolkit — codex-skills-toolkit · 19 Agent Skills para Codex · seguridad y supply chain · preflight y flujos funcionales · resiliencia y estado · evidencia de release · Python-first · pnpm · Cross-platform",
                "Rootcause Qr Inspector — rootcause-qr-inspector · 26 señales locales y 107 pruebas · cámara, imágenes y PDF · evidencia redactada · Flutter/Dart · local-first y telemetría cero · APK Android v0.1.4 publicado",
                "Chilean School Learning Path — 🇨🇱 Matemática y Lenguaje de 1° básico completos: 214 clases en 46 OA · 12.997 propuestas y 2.823 OA · fuentes MINEDUC, evaluación y dificultades de aula · Python + HTML · GitHub Pages",
                "Architecture Built Environment Learning Program — architecture-built-environment-learning-program · 680 clases en 68 partes y 2 fases · 12 rutas · 622 fuentes trazadas · Markdown, lector offline y GitHub Pages · Python · Español",
                "Pdf Reader Windows Android — PDF Reader v0.3.1 · lector PDF Android-first local y de solo lectura · navegación sin saltos, miniaturas acotadas e historial reabrible · Android 7+, Windows y Web · cero cuentas, permisos sensibles y telemetría · APK firmado",
                "Universal Payments Engineering Lab — Laboratorio autoexplicativo de ingeniería de pagos: 28 familias, DEMO local, estados, ledger, conciliación, seguridad y guías de implementación",
                "Psychometrics And Assessment Program — psychometrics-and-assessment-program · 5 instrumentos · 344 ítems · 81 escalas · scoring auditable · currículo: 40 clases (5 escritas) · licencias trazables · Python 3.11–3.13 · 57 tests",
                "Rootcause Server — RootCause Server v0.2.0 — plano de control en Rust que defiende servidores y la red que los rodea: superficie expuesta, ráfagas de autenticación, acceso concedido tras la ráfaga, integridad de archivos críticos y silencio del sensor. 18 reglas con evidencia y runbook — nunca ejecuta nada. Consola local sin dependencias web",
                "Aws Desktop Studio — AWS Desktop Studio · 15 integraciones de inventario + 20 tutoriales · AWS CLI, Electron y localhost · Implementación en desarrollo; no acceso universal · Windows",
                "Ai Dataset Foundry — AI Dataset Foundry v0.2.0 — factoría local-first para convertir PDF, Word, web, Git, JSON y CSV en datasets auditables para pretraining, fine-tuning, RAG y evaluación · Windows + Android offline",
                "Rootcause Blockchain Security — Laboratorio profesional watch-only de blockchain forensics y root cause analysis para Bitcoin, Ethereum y Polygon: TX, direcciones, reconciliación, grafos, timelines e informes con evidencia verificable. CLI + API local, cero dependencias, nunca claves privadas",
                "Rootcause Bitcoin Defense — ₿ RootCause Bitcoin Defense v0.3.0 — defensa watch-only y laboratorio forense UTXO: inputs, outputs, fees, change, procedencia, grafo de transacciones y reconciliación contable en regtest. App local, cero dependencias, nunca pide semillas ni usa fondos reales. Verificado en CI",
                "Decentraland Social Arcade — decentraland-social-arcade · Experiencia 3D social nativa de Decentraland · 1 MVP y arquitectura multijuego · SDK7 + ECS + TypeScript · documentación en español · sin pagos ni telemetría",
                "Commerce Operating System — Commerce OS v0.3.0 · demo conceptual guiada en 6 pestañas: catálogo, stock, CRM, pedidos, pagos mock y trazabilidad · Web, Windows y Android · Sin dinero ni SII real",
                "Panuelo Al Viento Cueca App — Pañuelo al Viento · Academia interactiva de cueca desde los 10 años · 24 clases, Dojo con huellas y espejo, Pañuelo Lab, Escenario guiado y progreso por habilidades · Flutter local-first · Android + Windows · v0.2.0",
                "Qemu Kvm Labs — qemu-kvm-labs · 12 labs de virtualización real · QEMU, KVM, libvirt, cloud-init y vm-manager · Linux + WSL2",
            ...
            "projects_ats": [
                ...
                ("Codex Skills Toolkit — codex-skills-toolkit · 19 Agent Skills para Codex · seguridad y supply chain · preflight y flujos funcionales · resiliencia y estado · evidencia de release · Python-first · pnpm · Cross-platform:", "codex"),
                ("Rootcause Qr Inspector — rootcause-qr-inspector · 26 señales locales y 107 pruebas · cámara, imágenes y PDF · evidencia redactada · Flutter/Dart · local-first y telemetría cero · APK Android v0.1.4 publicado:", "rootcause_qr"),
                ("Chilean School Learning Path — 🇨🇱 Matemática y Lenguaje de 1° básico completos: 214 clases en 46 OA · 12.997 propuestas y 2.823 OA · fuentes MINEDUC, evaluación y dificultades de aula · Python + HTML · GitHub Pages:", "chilean"),
                ("Architecture Built Environment Learning Program — architecture-built-environment-learning-program · 680 clases en 68 partes y 2 fases · 12 rutas · 622 fuentes trazadas · Markdown, lector offline y GitHub Pages · Python · Español:", "architecture"),
                ("Pdf Reader Windows Android — PDF Reader v0.3.1 · lector PDF Android-first local y de solo lectura · navegación sin saltos, miniaturas acotadas e historial reabrible · Android 7+, Windows y Web · cero cuentas, permisos sensibles y telemetría · APK firmado:", "pdf"),
                ("Universal Payments Engineering Lab — Laboratorio autoexplicativo de ingeniería de pagos: 28 familias, DEMO local, estados, ledger, conciliación, seguridad y guías de implementación:", "universal_payments"),
                ("Psychometrics And Assessment Program — psychometrics-and-assessment-program · 5 instrumentos · 344 ítems · 81 escalas · scoring auditable · currículo: 40 clases (5 escritas) · licencias trazables · Python 3.11–3.13 · 57 tests:", "psychometrics"),
                ("Rootcause Server — RootCause Server v0.2.0 — plano de control en Rust que defiende servidores y la red que los rodea: superficie expuesta, ráfagas de autenticación, acceso concedido tras la ráfaga, integridad de archivos críticos y silencio del sensor. 18 reglas con evidencia y runbook — nunca ejecuta nada. Consola local sin dependencias web:", "rootcause_server"),
                ("Aws Desktop Studio — AWS Desktop Studio · 15 integraciones de inventario + 20 tutoriales · AWS CLI, Electron y localhost · Implementación en desarrollo; no acceso universal · Windows:", "aws"),
                ("Ai Dataset Foundry — AI Dataset Foundry v0.2.0 — factoría local-first para convertir PDF, Word, web, Git, JSON y CSV en datasets auditables para pretraining, fine-tuning, RAG y evaluación · Windows + Android offline:", "ai"),
                ("Rootcause Blockchain Security — Laboratorio profesional watch-only de blockchain forensics y root cause analysis para Bitcoin, Ethereum y Polygon: TX, direcciones, reconciliación, grafos, timelines e informes con evidencia verificable. CLI + API local, cero dependencias, nunca claves privadas:", "rootcause_blockchain"),
                ("Rootcause Bitcoin Defense — ₿ RootCause Bitcoin Defense v0.3.0 — defensa watch-only y laboratorio forense UTXO: inputs, outputs, fees, change, procedencia, grafo de transacciones y reconciliación contable en regtest. App local, cero dependencias, nunca pide semillas ni usa fondos reales. Verificado en CI:", "rootcause_bitcoin"),
                ("Decentraland Social Arcade — decentraland-social-arcade · Experiencia 3D social nativa de Decentraland · 1 MVP y arquitectura multijuego · SDK7 + ECS + TypeScript · documentación en español · sin pagos ni telemetría:", "decentraland"),
                ("Commerce Operating System — Commerce OS v0.3.0 · demo conceptual guiada en 6 pestañas: catálogo, stock, CRM, pedidos, pagos mock y trazabilidad · Web, Windows y Android · Sin dinero ni SII real:", "commerce"),
                ("Panuelo Al Viento Cueca App — Pañuelo al Viento · Academia interactiva de cueca desde los 10 años · 24 clases, Dojo con huellas y espejo, Pañuelo Lab, Escenario guiado y progreso por habilidades · Flutter local-first · Android + Windows · v0.2.0:", "panuelo"),
                ("Qemu Kvm Labs — qemu-kvm-labs · 12 labs de virtualización real · QEMU, KVM, libvirt, cloud-init y vm-manager · Linux + WSL2:", "qemu"),
                ("Database Systems Labs — Programa abierto de ingeniería de bases de datos · 74 clases en 15 partes · 230 h · Del modelado conceptual a la arquitectura distribuida, la operación y la recuperación para IA · 120 fuentes con ISBN, DOI o norma citadas clase a clase y verificadas en CI · Glosario de 306 términos · El mismo caso resuelto en 27 motores:", "database"),
