...
def get_content(lang):
 ...
 ("Problem Driven Systems Lab — 12 desafíos × 5 stacks = 60 casos operativos Docker-first para diagnosticar y resolver problemas críticos de rendimiento, observabilidad, resiliencia y arquitectura:", "problem"),
                ...
                ("Modern Gamedev Program — El programa de desarrollo de videojuegos más completo en español — 45 clases listas de ~292 (18 partes), de fundamentos a nivel profesional. Matemáticas, C#/C++/GDScript, patrones y ECS; de un sprite a un plataformas 2D completo con Godot 4. Motores Godot · Unity · Unreal.:", "modern"),
 ...
 ("Problem Driven Systems Lab — 12 desafíos × 5 stacks = 60 casos operativos Docker-first para diagnosticar y resolver problemas críticos de rendimiento, observabilidad, resiliencia y arquitectura:", "problem"),
            ...
            "projects_ats": [
                ...
                ("RootCause · Windows Inspector v0.19.0 — Diagnóstico forense Windows 10/11 en Rust: ETW + WPR, 5 ediciones (Setup.exe, Portable .zip, CLI rootcause.exe, PowerShell .psm1, VS Code .vsix):", "rootcause"),
                            ("RootCause · Windows Inspector v0.19.0 — Diagnóstico forense Windows 10/11 en Rust: ETW + WPR, 5 ediciones (Setup.exe, Portable .zip, CLI rootcause.exe, PowerShell .psm1, VS Code .vsix):", "rootcause"),
                ("Modern Cybersecurity Program — El programa de ciberseguridad más completo en español — 340 clases, 19 partes, de fundamentos a nivel experto. Laboratorios Docker, retos CTF, autoevaluaciones, guías PDF/PPTX y mapeo a 7 certificaciones (Security+, PenTest+, CySA+, OSCP, CISSP, BTL1, SANS) con 86–92% de cobertura:", "modern"),
                ("Multi Cloud Engineering Program — ️ Multi-Cloud Engineering Program v2.0.0 · 288 clases en 24 partes · 1.288 horas · El programa de ingeniería multi-cloud más completo en español: AWS, Azure, GCP, Kubernetes, Terraform, SRE, FinOps y arquitectura de sistemas · Manual PDF de 1.220 páginas, 288 labs deterministas con evidencia JSON, CLI con certificado y portal PWA. ️:", "multi"),
],
            "training": [
 ...
 ("Problem Driven Systems Lab — 12 desafíos × 5 stacks = 60 casos operativos Docker-first para diagnosticar y resolver problemas críticos de rendimiento, observabilidad, resiliencia y arquitectura:", "problem"),
            ...
            "projects_ats": [
                ...
                ("ChofyAI Studio \u2014 launcher IA local macOS (Tauri + Rust + React):", "chofyai"),
                            ("Modern Business Creation Program — Programa de 24 partes y 336 clases para crear y operar una empresa real en Chile: de la idea a la constitución, el SII, la operación, la crisis y la salida. Con 360 diagramas, glosario de 1.251 términos y manual de 1.541 páginas en PDF:", "modern"),
                ("Rootcause Web Inspector — RootCause Web Inspector v0.1.0 — sensor forense de la superficie del navegador: cookies, sesiones de correo, extensiones, descargas y permisos de sitio. Panel local en 127.0.0.1, extension MV3, CERO dependencias y cero telemetria verificada en CI. Hermano de las ediciones Windows (Rust) y Mobile (Flutter):", "rootcause"),
],
            "training": [
