...
def get_content(lang):
    ...
    T["es"] = {
        ...
        "projects": [
            ...
            "<b>Problem Driven Systems Lab:</b> Laboratorio Docker-first con 12 problemas reales de ingeniería resueltos en 7 stacks (PHP · Python · Node.js · Java · .NET · Go · Rust): rendimiento, observabilidad, resiliencia, modernización legacy y arquitectura — con evidencia operacional verificable",
            "<b>Claude Skills Toolkit:</b> claude-skills-toolkit · 14 skills agentic para Claude Code · security-audit (12 capas: OSV/KEV/EPSS/SAST/…) · python-lint-guard (paridad local↔CI) · python-deps-pinning · version-bump · md-to-doc · yaml-control · md-lint-fix · docker-cleanup · Zero-deps por defecto · Cross-platform",
            "<b>Gabysql:</b> GabySQL · Base de datos embebida en Rust, multiplataforma, archivo único .db, WAL, API HTTP/JSON y admin web liviano. Diseñada para entornos embebidos y edge",
            "<b>Python Data Science Program:</b> Python Data Science Program v3.11.0 · 232 clases en 9 partes (100%) · App Windows Qt nativa (PySide6) con la clase en HTML + APK Android con las 232 clases embebidas + lab Python (Flask+Jupyter real) · Currículo Python/Polars, ML+Optuna/SHAP, DL (PyTorch/LLMs/LoRA-DPO/MCP/agentes/multimodal/JAX), estadística+causalidad, MLOps, ética, capstones",
            "<b>Automa · PC Orchestrator v0.2.0:</b> Orquestador local de acciones efectivas sobre Windows · 20 flows declarativos JSON que abren ventanas reales, interactúan con DOM, capturan evidencia · Panel local 127.0.0.1 (pywebview + PyInstaller) · Python 3.10+, Playwright (headless/visible), SQLite historial, OCR/visión, uv packaging, 115 pytest tests, instalador Windows firmado · Local-first",
            "<b>RootCause · Windows Inspector v0.11.0:</b> Diagnóstico forense para Windows 10/11 escrito en Rust (edition 2024) · Descubre qué proceso, servicio, carpeta, conexión o traza ETL degrada el equipo · 5 ediciones publicadas: GUI Setup.exe, Portable .zip, CLI single-binary rootcause.exe, módulo PowerShell .psm1, extensión VS Code .vsix · ETW · WPR · SHA256SUMS por release · Diagnóstico primero, intervención después",
            "<b>Rootcause Mobile Inspector:</b> RootCause Mobile v0.8.0 — sensor forense de diagnóstico para Android e iOS (Flutter). Compara cada app consigo misma para detectar consumo anómalo, señala stalkerware activo y distingue permisos concedidos de los solo pedidos. Evidencia PDF, 5 idiomas. Sin permiso INTERNET: telemetría cero, verificada en cada build",
            "<b>Modern Gamedev Program:</b> El programa de desarrollo de videojuegos más completo en español — 352 clases en 22 partes, de fundamentos a nivel profesional. 2D/3D, física, shaders, IA, audio, multijugador, VR/AR, optimización y producción; más especialización en ingeniería: sistemas de gameplay, backend, IA generativa y motores. Godot · Unity · Unreal",
            "<b>Modern Cybersecurity Program:</b> El programa de ciberseguridad más completo en español — 340 clases, 19 partes, de fundamentos a nivel experto. Laboratorios Docker, retos CTF, autoevaluaciones, guías PDF/PPTX y mapeo a 7 certificaciones (Security+, PenTest+, CySA+, OSCP, CISSP, BTL1, SANS) con 86–92% de cobertura",
            "<b>Machine Operator Program:</b> Base documental del Programa de Operación y Simulación de Máquinas — mandos, instrumentos, historia, reglamentos y diseño de simulación de motos, autos, buses, grúas, buques, aeronaves y naves espaciales, con foco educativo y de seguridad",
            "<b>Rhino Suite:</b> Rhino Suite · Suite ofimática web y de escritorio construida desde cero — editor de documentos con modelo estructurado, motores Rust/WASM + motor TypeScript compatible, API Go, intercambio DOCX/ODT y monorepo evolutivo por fases",
            "<b>Human Genome Labs:</b> Human Genome Labs v1.0 · Plataforma científica evolutiva y reproducible para genética molecular y genómica · Núcleo TypeScript: secuencias, traducción, ORF, variantes y G-cuádruplex · Contratos ScientificResult · FASTA/GFF3/VCF · Módulos con madurez y evidencia explícitas · CLI + lab web PWA + juego",
            "<b>Wsl Labs:</b> WSL Container Center · Levanta y controla contenedores en Windows con wslc, el motor de contenedores nativo de WSL — 12 casos reales portados de docker-labs, panel de control + launcher. Sin Docker Desktop",
            "<b>Computational Mathematics Program:</b> Matemática computacional en español · 18 partes · 360 clases en 5 etapas: de contar con los dedos a reproducir un paper · 360 demostraciones deterministas verificadas en CI · sin dependencias para aprender · 1080 notebooks · 489 términos de glosario · manual completo en PDF",
            "<b>Modern Business Creation Program:</b> Programa de 24 partes y 336 clases para crear y operar una empresa real en Chile: de la idea a la constitución, el SII, la operación, la crisis y la salida. Con 360 diagramas, glosario de 1.251 términos y manual de 1.541 páginas en PDF",
            "<b>Executive Leadership Founder Program:</b> Programa ejecutivo abierto de 288 clases en 24 partes · 720 h · De asumir tu primer resultado a dirigir una empresa y crear la tuya: liderazgo, equipos, talento, operaciones, KPI/OKR, finanzas, ventas, marketing, producto, estrategia, riesgo, IA, directorio, M&A y founder track Chile · 24 casos, 96 labs y 39 plantillas",
            "<b>Finance And Banking Evolution Program:</b> Programa abierto de 356 clases en 23 partes · 534 h · De calcular un porcentaje a construir y defender un banco digital: matemática financiera, contabilidad NIIF, crédito, riesgos, Basilea III, cumplimiento, finanzas abiertas, pagos transfronterizos, DLT, stablecoins, tokenización y MiCA · 26 casos y fuentes oficiales verificables en cada clase",
            "<b>Blockchain Learning Path:</b> Blockchain Learning Path v0.9.0 · Programa en español: 28 módulos de cero a la infraestructura financiera programable — cripto, Bitcoin, EVM, contratos, seguridad, L2, ZK, DeFi, dinero y liquidación, stablecoins, CBDC/MDBC, pagos y FX, tokenización, RWA, mercados de capitales, custodia y regulación. 70 prácticas, 186 pruebas, apps offline",
            "<b>Universal Code Scanner:</b> Universal Code Scanner v1.1.0 — Lector Flutter de códigos QR y de barras que interpreta antes de actuar: 16 señales de riesgo locales por URL, confirmación explícita, historial e inventario cifrados con AES-256-GCM. Estado de escaneo siempre visible y tono propio de lectura. Android · iOS · macOS · PWA. Telemetría cero",
            "<b>Sandbox Labs:</b> Laboratorio de aislamiento en Linux: ejecuta código, archivos y modelos de negocio ajenos bajo políticas declaradas, y emite evidencia firmada de qué controles se aplicaron de verdad en tu equipo. 36 casos en dos familias — sandboxes técnicos y mercado de capitales con dinero simulado. Experimental y educativo, no un producto de seguridad",
            "<b>Artificial Intelligence Evolution Program:</b> AI Evolution Program v0.2.0 · 180 clases en 15 partes con materia completa · 540 notebooks con ejercicios y soluciones · PDFs por parte + programa completo (~1.100 pags) · La evolución de la IA en español: simbólica, ML, deep learning, LLMs, RAG, agentes, MLOps, seguridad y frontera",
            "<b>Rootcause Web Inspector:</b> RootCause Web Inspector v0.1.0 — sensor forense de la superficie del navegador: cookies, sesiones de correo, extensiones, descargas y permisos de sitio. Panel local en 127.0.0.1, extension MV3, CERO dependencias y cero telemetria verificada en CI. Hermano de las ediciones Windows (Rust) y Mobile (Flutter)",
            "<b>Violin Adventure:</b> Mi Aventura con el Violín · App educativa para aprender violín desde los 10 años · 24 lecciones en 6 mundos, afinador cromático, metrónomo y práctica guiada · Tauri 2 + React + TypeScript · Windows, Android, Linux, macOS, iOS y PWA · Sin publicidad, sin cuentas, offline · v1.0.0, instaladores firmados en Releases",
            "<b>Multi Cloud Engineering Program:</b> Multi-Cloud Engineering Program v2.0.0 · 288 clases en 24 partes · 1.288 horas · El programa de ingeniería multi-cloud más completo en español: AWS, Azure, GCP, Kubernetes, Terraform, SRE, FinOps y arquitectura de sistemas · Manual PDF de 1.220 páginas, 288 labs deterministas con evidencia JSON, CLI con certificado y portal PWA.",
            "<b>Neural Network Training Labs:</b> Neural Network Training Labs v1.0 · 31 rutas (25 labs + 6 especializaciones) · 93 notebooks · Ciclo completo de ingeniería de IA con datasets públicos reales: sellado de test, registro champion/challenger, API de inferencia, ONNX/INT8/edge, DDP/FSDP2 y cadena de suministro (SBOM/SHA-256). PyTorch · Python 3.11–3.13",
            "<b>Polyglot Programming Labs:</b> El programa de programación comparada en español — 176 clases en 12 partes. Un concepto, 10 lenguajes del núcleo (Python, JS, TS, Java, C#, Go, Rust, C, SQL, PHP) verificados en CI, y un Atlas de ~40 familias. Aprende el concepto una vez y reconócelo en cualquier lenguaje",
                    "<b>Education Pedagogy Learning Sciences Program:</b> Pedagogía, Docencia y Ciencias del Aprendizaje v2.0.0 · 300 clases en 25 partes · El programa de formación pedagógica más completo en español: aprendizaje, didáctica, inclusión, currículum, evaluación, convivencia, IA educativa y liderazgo · Evidencia declarada por clase, 14 rutas por rol, 60 actividades de aula y portal offline 🇨🇱",
            "<b>Marketing Sales Growth Evolution Program:</b> Marketing, Sales & Growth Evolution Program v1.0.0 · 336 clases en 24 partes · El programa de marketing, ventas y crecimiento más completo en español: posicionamiento, pricing, venta consultiva, RevOps, growth, analítica e IA comercial · 1.344 conceptos, 1.008 métricas, 96 obras, 17 rutas por rol y portal offline 🇨🇱",
            "<b>Guitarra Adventure:</b> Mi Aventura con la Guitarra · App educativa para aprender guitarra desde los 10 años · 24 lecciones en 6 mundos, afinador de 6 cuerdas, metrónomo sin deriva y 11 notas grabadas de guitarra real · Tauri 2 + React + TypeScript · Windows, Android, Linux, macOS, iOS y PWA · Sin publicidad, sin cuentas, offline · v1.0.0 con instaladores en Releases",
            "<b>Agentic Plugins Toolkit:</b> agentic-plugins-toolkit · 6 plugins agénticos para Claude Code, OpenAI/Codex, Copilot, Gemini y MCP · repository-engineering · legacy-modernization · learning-program-studio · product-evolution · portfolio-governance · rootcause-response · 69 vistas generadas sin drift · Zero-deps",
            "<b>Operational Ai Agents:</b> operational-ai-agents · 13 agentes para Claude Code · repository-evolution · legacy-modernization · curriculum-evolution · portfolio-publication · security-remediation · incident-root-cause · professional-profile · Contrato + gates humanos + evidencia verificable · 39 evals deterministas · Zero-deps · Cross-platform",
            "<b>Empresa Operativa Chile:</b> v1.4.0 · Crear, operar y controlar una empresa chilena a través del tiempo: constitución con evidencia, capital y CPT, patente municipal con su base legal, IVA/PPM, F29, cierre anual inmutable y auditoría. Guía, manual y glosario dentro de la app. Android, Windows y navegador. Reglas con fuente oficial. Cero telemetría. 🇨🇱",
            "<b>Rootcause Macos Inspector:</b> RootCause macOS Inspector v0.1.0 — sensor forense de ciberseguridad para macOS (Rust): persistencia launchd, Gatekeeper, SIP, FileVault, XProtect, permisos TCC, procesos con firma y vecinos de red. Compara cada superficie con un estado bueno conocido y explica qué cambió, con evidencia. Telemetría: cero. Hermano de Windows, Web y Mobile",
            "<b>Codex Skills Toolkit:</b> codex-skills-toolkit · 19 Agent Skills para Codex · seguridad y supply chain · preflight y flujos funcionales · resiliencia y estado · evidencia de release · Python-first · pnpm · Cross-platform",
            "<b>Rootcause Qr Inspector:</b> rootcause-qr-inspector · 26 señales locales y 107 pruebas · cámara, imágenes y PDF · evidencia redactada · Flutter/Dart · local-first y telemetría cero · APK Android v0.1.4 publicado",
            "<b>Chilean School Learning Path:</b> 🇨🇱 Matemática y Lenguaje de 1° básico completos: 214 clases en 46 OA · 12.997 propuestas y 2.823 OA · fuentes MINEDUC, evaluación y dificultades de aula · Python + HTML · GitHub Pages",
            "<b>Architecture Built Environment Learning Program:</b> architecture-built-environment-learning-program · 680 clases en 68 partes y 2 fases · 12 rutas · 622 fuentes trazadas · Markdown, lector offline y GitHub Pages · Python · Español",
            "<b>Pdf Reader Windows Android:</b> PDF Reader v0.3.1 · lector PDF Android-first local y de solo lectura · navegación sin saltos, miniaturas acotadas e historial reabrible · Android 7+, Windows y Web · cero cuentas, permisos sensibles y telemetría · APK firmado",
            "<b>Universal Payments Engineering Lab:</b> Laboratorio autoexplicativo de ingeniería de pagos: 28 familias, DEMO local, estados, ledger, conciliación, seguridad y guías de implementación",
            "<b>Psychometrics And Assessment Program:</b> psychometrics-and-assessment-program · 5 instrumentos · 344 ítems · 81 escalas · scoring auditable · currículo: 40 clases (5 escritas) · licencias trazables · Python 3.11–3.13 · 57 tests",
            "<b>Rootcause Server:</b> RootCause Server v0.2.0 — plano de control en Rust que defiende servidores y la red que los rodea: superficie expuesta, ráfagas de autenticación, acceso concedido tras la ráfaga, integridad de archivos críticos y silencio del sensor. 18 reglas con evidencia y runbook — nunca ejecuta nada. Consola local sin dependencias web",
            "<b>Aws Desktop Studio:</b> AWS Desktop Studio · 15 integraciones de inventario + 20 tutoriales · AWS CLI, Electron y localhost · Implementación en desarrollo; no acceso universal · Windows",
            "<b>Ai Dataset Foundry:</b> AI Dataset Foundry v0.2.0 — factoría local-first para convertir PDF, Word, web, Git, JSON y CSV en datasets auditables para pretraining, fine-tuning, RAG y evaluación · Windows + Android offline",
            "<b>Rootcause Blockchain Security:</b> Laboratorio profesional watch-only de blockchain forensics y root cause analysis para Bitcoin, Ethereum y Polygon: TX, direcciones, reconciliación, grafos, timelines e informes con evidencia verificable. CLI + API local, cero dependencias, nunca claves privadas",
            "<b>Rootcause Bitcoin Defense:</b> ₿ RootCause Bitcoin Defense v0.3.0 — defensa watch-only y laboratorio forense UTXO: inputs, outputs, fees, change, procedencia, grafo de transacciones y reconciliación contable en regtest. App local, cero dependencias, nunca pide semillas ni usa fondos reales. Verificado en CI",
            "<b>Decentraland Social Arcade:</b> decentraland-social-arcade · Experiencia 3D social nativa de Decentraland · 1 MVP y arquitectura multijuego · SDK7 + ECS + TypeScript · documentación en español · sin pagos ni telemetría",
            "<b>Commerce Operating System:</b> Commerce OS v0.3.0 · demo conceptual guiada en 6 pestañas: catálogo, stock, CRM, pedidos, pagos mock y trazabilidad · Web, Windows y Android · Sin dinero ni SII real",
            "<b>Panuelo Al Viento Cueca App:</b> Pañuelo al Viento · Academia interactiva de cueca desde los 10 años · 24 clases, Dojo con huellas y espejo, Pañuelo Lab, Escenario guiado y progreso por habilidades · Flutter local-first · Android + Windows · v0.2.0",
            "<b>Qemu Kvm Labs:</b> qemu-kvm-labs · 12 labs de virtualización real · QEMU, KVM, libvirt, cloud-init y vm-manager · Linux + WSL2",
            "<b>Database Systems Labs:</b> Programa abierto de ingeniería de bases de datos · 74 clases en 15 partes · 230 h · Del modelado conceptual a la arquitectura distribuida, la operación y la recuperación para IA · 120 fuentes con ISBN, DOI o norma citadas clase a clase y verificadas en CI · Glosario de 306 términos · El mismo caso resuelto en 27 motores",
            "<b>Video Transcript Studio:</b> Un video, una lista o un CANAL COMPLETO de YouTube → texto con marcas de tiempo. Whisper 100% local: sin API, sin cuenta, sin telemetría. Asistente de 4 etapas en escritorio Windows + panel local en 127.0.0.1 + CLI, con la misma cola. MD, PDF, TXT, SRT, VTT, JSON, MP3, OGG. FFmpeg incluido. Modo oscuro. 89 tests. 🇪🇸",
            "<b>Framework Ecosystems Labs:</b> Laboratorio de clases comparadas: el mismo contrato ejecutable, sin adaptadores, contra Express, FastAPI, Spring Boot, ASP.NET, Django, Rails, Laravel, React, Vue, Svelte y más. 149 clases en 12 partes (70 construidas, 397 casos verificados en CI) · 210 fuentes con ISBN/DOI · seguridad, datos, interfaz",
],
 ...
 "problem": "Problem Driven Systems Lab",
 "python": "Python Data Science Program",
            "claude": "Claude Skills Toolkit",
            "gabysql": "Gabysql",
            "rootcause": "Rootcause Mobile Inspector",
            "modern": "Modern Gamedev Program",
            "machine": "Machine Operator Program",
            "rhino": "Rhino Suite",
            "human": "Human Genome Labs",
            "wsl": "Wsl Labs",
            "computational": "Computational Mathematics Program",
            "executive": "Executive Leadership Founder Program",
            "finance": "Finance And Banking Evolution Program",
            "blockchain": "Blockchain Learning Path",
            "universal": "Universal Code Scanner",
            "sandbox": "Sandbox Labs",
            "artificial": "Artificial Intelligence Evolution Program",
            "violin": "Violin Adventure",
            "multi": "Multi Cloud Engineering Program",
            "neural": "Neural Network Training Labs",
            "polyglot": "Polyglot Programming Labs",
            "education": "Education Pedagogy Learning Sciences Program",
            "marketing": "Marketing Sales Growth Evolution Program",
            "guitarra": "Guitarra Adventure",
            "agentic": "Agentic Plugins Toolkit",
            "operational": "Operational Ai Agents",
            "empresa": "Empresa Operativa Chile",
            "codex": "Codex Skills Toolkit",
            "chilean": "Chilean School Learning Path",
            "architecture": "Architecture Built Environment Learning Program",
            "pdf": "Pdf Reader Windows Android",
            "psychometrics": "Psychometrics And Assessment Program",
            "aws": "Aws Desktop Studio",
            "ai": "Ai Dataset Foundry",
            "decentraland": "Decentraland Social Arcade",
            "commerce": "Commerce Operating System",
            "panuelo": "Panuelo Al Viento Cueca App",
            "qemu": "Qemu Kvm Labs",
            "database": "Database Systems Labs",
            "video": "Video Transcript Studio",
