...
def get_content(lang):
 ...
 "<b>Problem Driven Systems Lab:</b> Laboratorio de sistemas distribuido con 12 desafíos × 5 stacks = 60 casos operativos Docker-first para diagnosticar y resolver problemas críticos de rendimiento, observabilidad, resiliencia y arquitectura",
            ...
            "<b>Gabysql:</b> ️ GabySQL · Base de datos embebida en Rust, multiplataforma, archivo único .db, WAL, API HTTP/JSON y admin web liviano. Diseñada para entornos embebidos y edge",
            ...
            "<b>Modern Gamedev Program:</b> El programa de desarrollo de videojuegos más completo en español — 45 clases listas de ~292 (18 partes), de fundamentos a nivel profesional. Matemáticas, C#/C++/GDScript, patrones y ECS; de un sprite a un plataformas 2D completo con Godot 4. Motores Godot · Unity · Unreal. ️",
            "<b>Modern Cybersecurity Program:</b> ️ El programa de ciberseguridad más completo en español — 340 clases, 19 partes, de fundamentos a nivel experto. Laboratorios Docker, retos CTF, autoevaluaciones, guías PDF/PPTX y mapeo a 7 certificaciones (Security+, PenTest+, CySA+, OSCP, CISSP, BTL1, SANS) con 86–92% de cobertura",
            "<b>Machine Operator Program:</b> ️ Base documental del Programa de Operación y Simulación de Máquinas — mandos, instrumentos, historia, reglamentos y diseño de simulación de motos, autos, buses, grúas, buques, aeronaves y naves espaciales, con foco educativo y de seguridad",
