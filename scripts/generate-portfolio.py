...
def get_content(lang):
    ...
    T["es"] = {
        ...
        "projects": [
            ...
            "<b>IA Ag\u00e9ntica:</b> LangGraph v4.2 + Ollama (IA local), 25 casos / 10 operativos, auditoría 8 capas, Docker/caso, CI/CD hardened",
 ...
 "<b>Problem Driven Systems Lab:</b> Laboratorio de sistemas distribuido con 12 casos reales Docker-first para diagnosticar y resolver problemas críticos de rendimiento, observabilidad, resiliencia y arquitectura",
 "<b>Python Data Science Bootcamp:</b> Bootcamp de Python para Data Science · Clases, notebooks, datasets y entorno interactivo local. Material docente para principiantes y transición profesional.",
            ...
            "<b>Python Data Science Program:</b> Python Data Science Program · 197 clases en 9 partes (Python aplicado, ML clásico, Deep Learning, estadística inferencial, MLOps, ingeniería de datos, recomendadores, ética, capstones). Laboratorio Flask interactivo + app de escritorio Windows + app Android",
],
 ...
 "python": "Python Data Science Bootcamp",
 ...
 "<b>Python Data Science Bootcamp:</b> Bootcamp de Python para Data Science · Clases, notebooks, datasets y entorno interactivo local. Material docente para principiantes y transición profesional.",
        ...
        "projects": [
            ...
            "<b>Agentic AI:</b> LangGraph v4.2 + Ollama (local AI), 25 cases / 10 operational, 8-layer hardening, Docker per case, hardened CI/CD",
 ...
 "<b>Python Data Science Bootcamp:</b> Bootcamp de Python para Data Science · Clases, notebooks, datasets y entorno interactivo local. Material docente para principiantes y transición profesional.",
        ...
        "projects": [
            ...
            "<b>IA Ag\u00eantica:</b> LangGraph v4.2 + Ollama (IA local), 25 casos / 10 operativos, auditoría 8 capas, Docker/caso, CI/CD hardened",
 ...
 "<b>Python Data Science Bootcamp:</b> Bootcamp de Python para Data Science · Clases, notebooks, datasets y entorno interactivo local. Material docente para principiantes y transición profesional.",
        ...
        "projects": [
            ...
            "<b>IA Agentica:</b> LangGraph v4.2 + Ollama (IA locale), 25 casi / 10 operativi, audit 8 livelli, Docker/caso, CI/CD hardened",
 ...
 "<b>Python Data Science Bootcamp :</b> Bootcamp de Python para Data Science · Clases, notebooks, datasets y entorno interactivo local. Material docente para principiantes y transición profesional.",
        ...
        "projects": [
            ...
            "<b>IA Agentique :</b> LangGraph v4.2 + Ollama (IA locale), 25 cas / 10 opérationnels, audit 8 couches, Docker/cas, CI/CD hardened",
