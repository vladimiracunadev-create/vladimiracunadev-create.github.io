...
def get_content(lang):
 ...
 "<b>Problem Driven Systems Lab:</b> Laboratorio de sistemas distribuido con 12 desafíos × 5 stacks = 60 casos operativos Docker-first para diagnosticar y resolver problemas críticos de rendimiento, observabilidad, resiliencia y arquitectura",
            "<b>Claude Skills Toolkit:</b> claude-skills-toolkit · Skills agentic para Claude Code · security-audit (12 capas: OSV/KEV/EPSS/SAST/...) · yaml-control · md-lint-fix · docker-cleanup · Zero-deps por defecto · Cross-platform",
            ...
            "<b>Python Data Science Program:</b> Python Data Science Program · 232 clases en 9 partes (Python aplicado, ML clásico, Deep Learning, estadística inferencial, MLOps, ingeniería de datos, recomendadores, ética, capstones). Laboratorio Flask interactivo + app de escritorio Windows nativa (PySide6 + Qt + kernel Jupyter) + app Android (Expo SDK 51). 232 PDFs + 232 PPTX generados",
            ...
            "<b>Rootcause Mobile Inspector:</b> RootCause Mobile — sensor forense de diagnóstico para Android e iOS (Flutter). Toda distorsión anómala de recursos (memoria, almacenamiento, batería, superficie de permisos) puede ser el primer indicio de una amenaza: la detecta con motor de reglas local y deja evidencia exportable. APK firmado en Releases. Telemetría: cero",
            "<b>Modern Gamedev Program:</b> El programa de desarrollo de videojuegos más completo en español — 45 clases listas de ~292 (18 partes), de fundamentos a nivel profesional. Matemáticas, C#/C++/GDScript, patrones y ECS; de un sprite a un plataformas 2D completo con Godot 4. Motores Godot · Unity · Unreal. ",
            ...
            "<b>Sandbox Labs:</b> ️ Laboratorio de aislamiento en Linux: ejecuta código, archivos y modelos de negocio ajenos bajo políticas declaradas, y emite evidencia firmada de qué controles se aplicaron de verdad en tu equipo. 36 casos en dos familias — sandboxes técnicos y mercado de capitales con dinero simulado. Experimental y educativo, no un producto de seguridad",
