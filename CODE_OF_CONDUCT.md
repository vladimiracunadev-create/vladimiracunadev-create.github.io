...
Como profesional enfocado en la **ingeniería de software, calidad y observabilidad**, espero interacciones constructivas de quienes aporten o revisen este código.

Ejemplos de comportamiento que contribuyen a crear un ambiente positivo:
* Demostrar empatía y amabilidad hacia las demás personas.
* Respetar las diferentes opiniones, puntos de vista y experiencias.
* Dar y recibir retroalimentación constructiva con gracia.
* Aceptar la responsabilidad, disculparse con los afectados por nuestros errores y aprender del incidente.
* Centrarse en lo que es mejor, no solo para nosotros como individuos, sino para la comunidad en general.

Ejemplos de comportamiento inaceptable:
* El uso de lenguaje o imágenes sexualizadas, y aproximaciones o atenciones sexuales de cualquier tipo.
* Comentarios despectivos (*trolling*), insultos y ataques personales o políticos.
...
## Atribución
Este Código de Conducta está adaptado de la versión 2.1 del *Contributor Covenant*, disponible en [https://www.contributor-covenant.org/version/2/1/code_of_conduct.html](https://www.contributor-covenant.org/version/2/1/code_of_conduct.html).
